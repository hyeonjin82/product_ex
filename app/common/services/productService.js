(function () {
    ...
    function productService() {
        ...
        function calculateFromPercent(cost, percent) {
            var price = cost;
            if(cost && percent) {
        ...
        function calculateFromAmount(cost, amount) {
            var price = cost;
            if(cost && amount) {
                price = cost + amount;
                price = (Math.round(price * 100)) / 100;
        ...
        return {
            ...
            calculateFromPercent: calculateFromPercent,
            calculateFromAmount: calculateFromAmount
        }
    }
